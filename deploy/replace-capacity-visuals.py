...
figures = [
    ('          <h2 id="cells">', '''          <figure class="article-image">
            <img src="../../assets/articles/capacity-fake-vs-helionyx.svg" alt="Сравнение аккумулятора с неподтверждёнными 9800 мАч и аккумулятора HELIONYX с реальной ёмкостью" loading="lazy" width="1200" height="900">
    ...
    ('          <h2 id="why-works">', '''          <figure class="article-image">
            <img src="../../assets/articles/helionyx-quality-and-safety.svg" alt="Аккумулятор HELIONYX: сертификаты, UN38.3, испытания, защита и понятная цена" loading="lazy" width="1200" height="900">
    ...
    ('          <h2 id="checklist">', '''          <figure class="article-image">
            <img src="../../assets/articles/cheap-battery-fire-risk.svg" alt="Риск перегрева и возгорания подозрительно дешёвого аккумулятора без подтверждённых испытаний" loading="lazy" width="1200" height="900">
...
print("Установлены три новые иллюстрации; негативный кейс с упоминанием HELIONYX удалён.")
